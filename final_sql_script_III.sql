# duration 23 min
DROP TABLE IF EXISTS t_martin_danek_project_SQL_final_III;

CREATE TABLE
    t_martin_danek_project_SQL_final_III (
        date date,
        country varchar(255),
        confirmed int,
...
WITH country_key as (
    ...
    LEFT OUTER JOIN
     ...
     life_exp as (
         SELECT le.iso3,
                MAX(CASE WHEN le.year = 2015 THEN life_expectancy END) as life_expectancy_2015,
    ...
    ROUND(lexp.life_expectancy_2015 - lexp.life_expectancy_1965, 2) as life_exp_improvement,
    ...
    LEFT OUTER JOIN life_exp as lexp
    on lexp.iso3 = ck.iso3
